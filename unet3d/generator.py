...
def get_training_and_validation_generators(data_file, batch_size, n_labels, training_keys_file, validation_keys_file,
    ...
    print(data_file)
    print(training_list, validation_list)
...
def get_data_from_file(data_file, index, patch_shape=None):
    if patch_shape:
        ...
        data, truth = data_file.root.data[index], data_file.root.truth[index, 0]#get_data_from_file(data_file, index, patch_shape=None)
